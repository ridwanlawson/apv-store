...
const dict: Record<Lang, Record<string, string>> = {
  en: {
    ...
    successEmpty: "No order here — open this page right after checkout.",
    ...
    footShip: "Shipping", footRet: "Returns", footPriv: "Privacy", footTerms: "Terms", footSize: "Size guide",
    footNote: "Duties (DDU) by buyer · Returns 30 days (buyer pays return shipping)",
    cookieT: "Cookies. Essentials only. Privacy-friendly analytics (Umami, no cookies) run only if you agree.",
  ...
  id: {
    ...
    successEmpty: "Tidak ada order di sini — buka halaman ini tepat setelah checkout.",
    continueBtn: "Lanjut belanja",
    ...
    footShip: "Pengiriman", footRet: "Retur", footPriv: "Privasi", footTerms: "Syarat", footSize: "Panduan ukuran",
    footNote: "Bea (DDU) pembeli · Retur 30 hari (ongkir retur pembeli)",
    cookieT: "Cookie. Hanya yang esensial. Analitik ramah privasi (Umami, tanpa cookie) jika kamu setuju.",
  ...
  ja: {
    ...
    successEmpty: "注文がありません — 決済直後にこのページを開いてください。",
    continueBtn: "買い物を続ける",
    ...
    footShip: "配送", footRet: "返品", footPriv: "プライバシー", footTerms: "利用規約", footSize: "サイズガイド",
    footNote: "関税(DDU)は購入者負担 · 返品30日(返送料は購入者負担)",
    cookieT: "Cookieは必須のみ。プライバシー重視の分析(Umami・Cookieなし)は同意時のみ実行。",
